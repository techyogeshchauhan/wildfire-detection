...
def main():
    ...
    # Sidebar information
    st.sidebar.markdown("Developed by Prakhar Joshi")
    st.sidebar.markdown("LinkedIn: [Profile](https://www.linkedin.com/in/prakhar-joshi123/)")
    st.sidebar.markdown("GitHub: [Repo](https://github.com/PrakharJoshi54321)")
    st.sidebar.markdown("Email: [joshi.prakhar110@gmail.com](mailto:joshi.prakhar110@gmail.com)")
    # st.sidebar.markdown("Telegram: [@Prakhar Joshi]()")
    ...
    with col2:
        ...
        st.image(logo, use_column_width=True, caption="Save the wildlife")
    with col3:
        st.write("")

    st.sidebar.image(logo, use_column_width=True, caption="Save the wildlife")
    ...
    <div style='text-align: center;'>
        ...
        <p>Welcome to our Wildfire Detection App!</p>
        <h3>🌍 <strong>Preventing Wildfires with Computer Vision</strong></h3>
        <p>Goal is to prevent wildfires by detecting fire and smoke in images with high accuracy and speed.</p>
        <h3>📸 <strong>Try It Out!</strong></h3>
        <p>Experience the effectiveness of detection model by uploading an image or providing a URL.</p>
    </div>
    """,
    unsafe_allow_html=True
)
